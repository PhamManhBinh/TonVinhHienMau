          ...
          <ul class="menu">
            ...
            <li class="sidebar-item active has-sub">
              ...
              <ul class="submenu active">
                ...
                <li class="submenu-item">
                  <a href="{{ url('/DanhSachTonVinh') }}">Danh sách đợt tôn vinh</a>
                </li>
                <li class="submenu-item">
                                ...
                                <form class="form border border-secondary" method="POST" enctype="multipart/form-data">
                                  ...
                                  <div class="form-body">
                                    <div class="form-group">
                                      <label>Đợt tôn vinh</label>
                                      <input type="text" class="form-control mt-2 py-2" name="dot-tv">
                                      @if ($errors->has('dot-tv'))
                                      {{ $errors->first('dot-tv')}}
                                      @endif
                                    </div>
                                    <div class="form-group">
                                      <label>Ngày tạo</label>
                                      <input type="text" class="form-control mt-2 py-2" name="ngay-tao">
                                      @if ($errors->has('ngay-tao'))
                                      {{ $errors->first('ngay-tao')}}
                                      @endif
                                    </div>
                                  </div>
